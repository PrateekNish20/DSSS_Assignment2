...
def math_quiz():
    ...
    for _ in range(int(total_questions)):
        n1 = Random_Integer_Generator(1, 10); n2 = Random_Integer_Generator(1, 5); o = Operator()
    ...
    print(f"\nGame over! Your accuracy is: {score}/{total_questions} = {score/(total_questions)*100} percent")
